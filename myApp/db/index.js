const db = {
    ...
    productos: [
...

        {
            ...
            descripcion: "Crimen y castigo es una novela de carácter psicológico escrita por el autor ruso Fiódor Dostoievski. Fue publicada por primera vez en la revista El mensajero Ruso, en 1866, en doce partes, y publicada después como novela.",
            comentarios: [
                {
                    user: "carlosperez",
                    textoComentario: "Que tamaño tiene el libro?",
        ...
        {
            imagen: "https://http2.mlstatic.com/D_NQ_NP_692783-MLU72590153693_102023-V.webp",
            nombre: "Taylor. From the Vault.",
        ...
        {
            imagen: "https://http2.mlstatic.com/D_NQ_NP_895389-MLU72522555906_102023-V.webp",
            nombre: "Adiós Cachorra",
            descripcion: "No estar en pareja está bien, separarse está bien, tener apps de citas está bien, salir y divertirse está bien. Lo que no está bien bajo ningún punto de vista es que sigamos permitiendo que la frustración que nos genera el ghosting, las cancelaciones de los encuentros a último momento, los chats abandonados, las promesas incumplidas por parte de gente que recién habíamos comenzado a conocer nos llenen de inseguridades, dudas y autoboicot. En esta graciosa ficción, tres mujeres con distintas personalidades y a quienes el mundo de las primeras citas les resulta un enigma se conocerán en un viaje. Ava, una australiana de treinta años que decide irse a París después de una última salida fallida con uno de Tinder que la rechazó y que encima olía a salchichas, huevo y arroz. Oli, una arquitecta de veintisiete años, estadounidense y millonaria que resuelve irse a la Ciudad Luz luego de descubrir que Ben, uno con el que se vio una vez por semana durante dos años y que supuestamente “no estaba para nada serio”, se puso de novio con otra. E Isa, una española que atraviesa una crisis existencial porque se divorció de su marido de toda la vida y sus hijos ya son grandes y no la demandan como antes. Allí conocerán a Lili, una argentina de cuarenta años que en su pasado lo único que tenía eran miles de intentos de relaciones fallidas y no entendía por qué. Esa frustración la llevó a buscar soluciones en libros de sociología, psicología, neurociencia y divulgación feminista. Su investigación la condujo a encontrar respuestas a su dilema y desde entonces sus citas son siempre un éxito. Lili las ayudará a entender por qué no consiguen pasar de los primeros encuentros y les dará herramientas para lograr ser auténticas y vistas en todas esas oportunidades. Y vos, lectora, ¿estás lista para hackear el mundo citero?",
            comentarios: [
                {
                    user: "carlosperez",
                    textoComentario: "Que tamaño tiene el libro?",
